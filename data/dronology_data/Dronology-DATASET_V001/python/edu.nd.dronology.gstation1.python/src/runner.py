...
class GCSRunner:
    ...
    def _start(self):
        ...
        self._ctrl_station = control.ControlStation(self._connection, self._g_id,
                                                    self._dronology_in, self._dronology_handshake_out,
                                                    self._dronology_state_out, self._new_vehicle_in,
                                                    rtk_config=self._global_cfg['rtk_config'])
