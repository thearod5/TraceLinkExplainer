 ...
 * When activated, UAVs are registered with the fleet manager and can be retrieved for {@link assigning routes} to them.
 * 
 *  
...
public class DroneFleetManager {
	...
	public void unregisterDrone(String id) throws DroneException {
